...
exports.runValidateRecordingJob = runValidateRecordingJob;
...
async function runValidateRecordingJob(payload) {
    const { sessionId, storageKey, mimeType, languageHint, promptText, maxDurationSec = 5, } = payload;
    // 1. Mime type check
    ...
    let audioBuffer;
    try {
        audioBuffer = await (0, storage_1.getAudioBuffer)(storageKey);
    }
    catch {
...
// --- helpers ---
function hasValidAudioHeader(buffer, mimeType) {
